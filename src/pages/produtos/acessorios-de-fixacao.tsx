...
export default function Produtos({ data }: any) {
    ...
    const acessoriosDeFixacao = tools.filter((tool: any) => tool.categories.includes(40))
                    ...
                    <div className="row">
                        ...
                        <div className="col-12">
                            <div className={styles.pageIndication}>
                                ...
                                <a href="#">Acessórios de Fixação</a>
                            </div>
                        </div>

                        <div className="col-12">
                            <div className={styles.products}>
                                {acessoriosDeFixacao.map(tool =>(
...
export const getStaticProps: GetStaticProps = async () => {
    const { data } = await api.get('tools?per_page=100&_embed&categories=40',  {
        params: {
            _limit: 12,
            _order: 'desc'
        }
