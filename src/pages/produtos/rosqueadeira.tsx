...
export default function Produtos({ data }: any) {
    ...
    const rosqueadeira = tools.filter((tool: any) => tool.categories.includes(44))
                    ...
                    <div className="row">
                        ...
                        <div className="col-12">
                            <div className={styles.pageIndication}>
                                ...
                                <a href="#">Rosqueadeira</a>
                            </div>
                        </div>

                        <div className="col-12">
                            <div className={styles.products}>
                                {rosqueadeira.map(tool =>(
...
export const getStaticProps: GetStaticProps = async () => {
    const { data } = await api.get('tools?per_page=100&_embed&categories=44&orderby=title&order=asc',  {
        params: {
            _limit: 12,
            _order: 'desc'
        }
