...
export default function Produtos({ data }: any) {
    ...
    const fresasMdInteiricas = tools.filter((tool: any) => tool.categories.includes(42))
                    ...
                    <div className="row">
                        ...
                        <div className="col-12">
                            <div className={styles.pageIndication}>
                                ...
                                <a href="#">Fresas MD Inteiriças</a>
                            </div>
                        </div>

                        <div className="col-12">
                            <div className={styles.products}>
                                {fresasMdInteiricas.map(tool =>(
...
export const getStaticProps: GetStaticProps = async () => {
    const { data } = await api.get('tools?per_page=100&_embed&categories=42&orderby=title',  {
        params: {
            _limit: 12,
            _order: 'desc'
        }
