...
export default function Produtos({ data }: any) {
    ...
    const coneBt = tools.filter((tool: any) => tool.categories.includes(31))
    const coneSkIso = tools.filter((tool: any) => tool.categories.includes(32))
    const coneHskA = tools.filter((tool: any) => tool.categories.includes(33))
    const coneHskE = tools.filter((tool: any) => tool.categories.includes(34))
    const coneCapto = tools.filter((tool: any) => tool.categories.includes(35))
    const acessoriosParaCones = tools.filter((tool: any) => tool.categories.includes(36))
    const portaFerramentaHsk = tools.filter((tool: any) => tool.categories.includes(37))
    const sistemaVdi = tools.filter((tool: any) => tool.categories.includes(38))
    const informacoesTecnicas = tools.filter((tool: any) => tool.categories.includes(39))
                    ...
                    <div className="row">
                        ...
                        <div className="col-12">
                            <div className={styles.sidebar}>
                                <ul><li>1 - Cone BT 30/40/50</li></ul>
                            </div>
                            ...
                            <div className={styles.sidebar}>
                                <ul><li>2 - Cone SK ISO" 30/40/50</li></ul>
                            </div>
                            ...
                            <div className={styles.sidebar}>
                                <ul><li>3 - Cone HSK-A 63/100</li></ul>
                            </div>
                            ...
                            <div className={styles.sidebar}>
                                <ul><li>4 - Cone HSK-E 32/40/50</li></ul>
                            </div>
                            ...
                            <div className={styles.sidebar}>
                                <ul><li>5 - Cone Capto PSC 40/50/63</li></ul>
                            </div>
                            ...
                            <div className={styles.sidebar}>
                                <ul><li>6 - Acessórios para Cones</li></ul>
                            </div>

                            <div className={styles.products}>
                                {acessoriosParaCones.map(tool =>(
                                    <div className={styles.productsBox} key={tool.id}>
                                        <div className={styles.productsImg}>
                                            <img 
                                                width="100%" 
                            ...
                            <div className={styles.sidebar}>
                                <ul><li>7 - Porta Ferramenta - HSK</li></ul>
                            </div>

                            <div className={styles.products}>
                                {portaFerramentaHsk.map(tool =>(
                                    <div className={styles.productsBox} key={tool.id}>
                                        <div className={styles.productsImg}>
                                            <img 
                                                width="100%" 
                            ...
                            <div className={styles.sidebar}>
                                <ul><li>10 - Informações técnicas</li></ul>
                            </div>

                            <div className={styles.products}>
                                {informacoesTecnicas.map(tool =>(
                                    <div className={styles.productsBox} key={tool.id}>
                                        <div className={styles.productsImg}>
                                            <img 
                                                width="100%" 
...
export const getStaticProps: GetStaticProps = async () => {
    const { data } = await api.get('tools?per_page=100&_embed&categories=39,38,37,36,35,34,33,32,31',  {
        params: {
            _limit: 12,
            _order: 'desc'
        }
