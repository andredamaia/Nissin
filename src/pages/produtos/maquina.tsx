...
export default function Produtos({ data }: any) {
    ...
    const multiAplicacao = tools.filter((tool: any) => tool.categories.includes(19))
    const laminador = tools.filter((tool: any) => tool.categories.includes(20))
    const canalHelicoidal = tools.filter((tool: any) => tool.categories.includes(22))
    const canalReto = tools.filter((tool: any) => tool.categories.includes(23))
    const pontaHelicoidal = tools.filter((tool: any) => tool.categories.includes(24))
    const sinterizado52hrc = tools.filter((tool: any) => tool.categories.includes(25))
    const metalDuro60hrc = tools.filter((tool: any) => tool.categories.includes(26))
                    ...
                    <div className="row">
                        ...
                        <div className="col-12">
                            <div className={styles.sidebar}>
                                <ul><li>1 - Multi Aplicação</li></ul>
                            </div>

                            <div className={styles.products}>
                                {multiAplicacao.map(tool =>(
                            ...
                            <div className={styles.sidebar}>
                                <ul><li>3 - Sinterizado 45hrc</li></ul>
                            </div>
                            ...
                            <div className={styles.sidebar}>
                                <ul><li>4 - Sinterizado 52hrc</li></ul>
                            </div>

                            <div className={styles.products}>
                                {sinterizado52hrc.map(tool =>(
                                    <div className={styles.productsBox} key={tool.id}>
                                        <div className={styles.productsImg}>
                                            <img 
                                                width="100%" 
                            ...
                            <div className={styles.sidebar}>
                                <ul><li>5 - Metal Duro 60hrc</li></ul>
                            </div>

                            <div className={styles.products}>
                                {metalDuro60hrc.map(tool =>(
                                    <div className={styles.productsBox} key={tool.id}>
                                        <div className={styles.productsImg}>
                                            <img 
                                                width="100%" 
...
export const getStaticProps: GetStaticProps = async () => {
    const { data } = await api.get('tools?per_page=100&_embed&categories=19,20,22,23,24,25,26&orderby=title&order=asc',  {
        params: {
            _limit: 12,
            _order: 'desc'
        }
