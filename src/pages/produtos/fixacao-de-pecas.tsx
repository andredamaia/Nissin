...
export default function Produtos({ data }: any) {
    ...
    const fixacaoDePecas = tools.filter((tool: any) => tool.categories.includes(41))
                    ...
                    <div className="row">
                        ...
                        <div className="col-12">
                            <div className={styles.pageIndication}>
                                ...
                                <a href="#">Fixação de Peças</a>
                            </div>
                        </div>

                        <div className="col-12">
                            <div className={styles.products}>
                                {fixacaoDePecas.map(tool =>(
...
export const getStaticProps: GetStaticProps = async () => {
    const { data } = await api.get('tools?per_page=100&_embed&categories=41',  {
        params: {
            _limit: 12,
            _order: 'desc'
        }
