...
export default function Produtos({ data }: any) {
    ...
    const fresasMdRoscada = tools.filter((tool: any) => tool.categories.includes(43))
                    ...
                    <div className="row">
                        ...
                        <div className="col-12">
                            <div className={styles.pageIndication}>
                                ...
                                <a href="#">Fresas MD Roscada</a>
                            </div>
                        </div>

                        <div className="col-12">
                            <div className={styles.products}>
                                {fresasMdRoscada.map(tool =>(
...
export const getStaticProps: GetStaticProps = async () => {
    const { data } = await api.get('tools?per_page=100&_embed&categories=43',  {
        params: {
            _limit: 12,
            _order: 'desc'
        }
